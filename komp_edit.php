...
<body>
    ...
    <div class="container">
        <div class="card m-5">
            <div class="card-body">
                <h2 class="text-center">EDIT KOMPETENSI</h2>
                <form method="post">
                    <div class="mb-3">
                        <label class="form-label">Kode Kompetensi</label>
                        <input type="text" class="form-control" name="kd_kompetensi" value='<?php echo 
$row['kd_kompetensi'];?>' placeholder="Masukkan Kode Kompetensi" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Nama Kompetensi</label>
                        <input type="text" class="form-control" name="nama_kompetensi" value='<?php echo 
$row['nama_kompetensi'];?>' placeholder="Masukkan Nama Kompetensi">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Program Keahlian</label>
                        <input type="text" class="form-control" name="prog_keahlian" value='<?php echo 
$row['prog_keahlian'];?>' placeholder="Masukkan Program Keahlian">
                    </div>
